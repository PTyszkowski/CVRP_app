...
def count_total_distance(roads, distance_matrix, depot_distance_array):
    total_distance = 0
...
def solver(df, capacity, iterations, depot_coords):
    ...
    for start_angle in np.linspace(0, 360, iterations):
        ...
        distance = count_total_distance(roads, distance_matrix, depot_distance_array)
    ...
    return min_distance, best_routes, best_loads
